...
const { PYTHAGORA_DELIMITER } = require('@pythagora.io/js-code-processing').common;
const { green, yellow, red, blue, bold, reset } = require('@pythagora.io/js-code-processing').colors;
