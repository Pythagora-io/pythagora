...
npx pythagora --expand-unit-tests --path <PATH_TO_YOUR_TEST_SUITE>
```
When running the command `PATH_TO_YOUR_TEST_SUITE` can be a path to a single test file or to a folder and all test files inside of that folder will be processed and expanded.
...
- **How accurate are these tests?**
  ...
  - Here are a couple of observations we've made while testing Pythagora:
    ...
    3. It's definitely not perfect but I wanted to keep and commit the tests it created. So, I encourage you to try it out and see how it works for you. If you do that, please let us know via [email](mailto:hi@pythagora.ai) or [Discord](https://discord.gg/npC5TAfj6e). We're super excited to hear how it went for you.
<br><br>
